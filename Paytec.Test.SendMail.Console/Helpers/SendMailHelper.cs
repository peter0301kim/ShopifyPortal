...
namespace Paytec.Test.SendMail.Console.Helpers
{
    ...
    public static class SendMailHelper
    {
        ...
        public static bool SendEmailTest()
        {
            ...
            {
                Credentials = new NetworkCredential("print1@paytec.com.au", "Noafl2020!"),
                EnableSsl = true
            };

            try
            {
                client.Send("peter@paytec.com.au", "peter0301.kim@gmail.com", "test", "testbody"); return true;
            }
            catch (Exception ex)
            {
                Log.Error(ex.ToString());
