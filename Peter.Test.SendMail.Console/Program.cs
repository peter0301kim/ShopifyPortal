...
using NLog;
using Peter.Test.SendMail.Console.Helpers;
using Peter.Test.SendMail.Console.SettingModels;
using System.Reflection;

namespace Peter.Test.SendMail.Console;
...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        emailBody = emailBody.Replace("{Email}", "user@Peter.com.au");
