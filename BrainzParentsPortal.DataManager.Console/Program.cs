...
namespace BrainzParentsPortal.DataManager.Console;
...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            System.Console.WriteLine($"-------------------------------------------------------------------------");
            System.Console.WriteLine($"--------------------- BrainzParentsPortal.DataManager  ------------------");
            System.Console.WriteLine($"-------------------------------------------------------------------------");
    ...
    static bool InsertDefaultMembers()
    {
        ...
        List<Member> members = new List<Member>()
        {
            new Member
            {
                MemberID = "DEFAULT_ADMIN_01",Email = "peter@paytec.com.au",FirstName = "Admin-Peter",LastName = "Kim",
            ...
            new Member
            {
                MemberID = "DEFAULT_ADMIN_02",Email = "matt@paytec.com.au",FirstName = "Matt",LastName = "Ryan",
                Password = EncryptionHelper.SHA512("Brainz123!@#"), Phone = "", Role = "Administrator",
